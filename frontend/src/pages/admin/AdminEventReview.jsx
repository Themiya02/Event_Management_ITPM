...
import './UpcomingEvents.css'; // Base modal classes if needed
...
const AdminEventReview = () => {
    ...
    if (!event) {
        ...
        return (
            <div className="review-page animation-fade-in" style={{textAlign:'center'}}>
            ...
            <div className="review-card">
                <div className={`review-hero ${event.imageUrl ? 'has-image' : 'no-image'}`}>
                    {event.imageUrl ? (
                        ...
                        <span className="hero-placeholder">{event.name.charAt(0)}</span>
                    )}
                </div>
                ...
                <div className="review-content">
                    ...
                    <div className="event-meta-grid">
                        ...
                        {event.artistName && (
                            <div className="meta-item">
                                ...
                                <span className="meta-value">🎤 {event.artistName}</span>
                            </div>
                        )}
                        <div className="meta-item">
                            <span className="meta-label">Date & Time</span>
                            <span className="meta-value">📅 {new Date(event.date).toLocaleDateString()} at {event.time}</span>
                        </div>
                        <div className="meta-item">
                    ...
                    <div className="status-grid">
                        <div className="status-block">
                            <span className="status-block-title">Event Type</span>
                            <span className="meta-value" style={{fontSize: '1.15rem'}}>
                        ...
                        <div className="status-block">
                            ...
                            <span className="meta-value" style={{fontSize: '1.15rem', color: event.isPaid ? '#D97706' : '#059669'}}>
                    ...
                    <div className="review-approval-section">
                        <div className="review-approval-header">
                            ...
                            <p>Every department must review and physically authorize the event parameters before it becomes visible to the campus.</p>
                        </div>
